defmodule TodoPractice.TodosTest do
  use TodoPractice.DataCase
  ...
  describe "todos" do
    ...
    @invalid_attrs %{complete: nil, priority: nil, title: nil}
    ...
    test "create_todo/1 with valid data creates a todo" do
      valid_attrs = %{complete: true, priority: "some priority", title: "some title"}
